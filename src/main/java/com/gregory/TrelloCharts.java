...
public final class TrelloCharts {
    ...
    private static final String TRELLO_BOARD_FOR_ADDING_CARDS_ID = "trelloBoardForAddingCardsId";

    private final String trelloKey;
    private final String trelloAccessToken;
    private final String trelloBoardForAddingCardsId;
    ...
    public TrelloCharts() throws IOException {
        ...
        this.trelloBoardForAddingCardsId = properties.getProperty(TRELLO_BOARD_FOR_ADDING_CARDS_ID);
    }
